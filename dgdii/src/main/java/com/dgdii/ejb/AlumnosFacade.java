...
public class AlumnosFacade extends AbstractFacade<Alumnos> {
    ...
    public List<Alumnos> findAlumnosByCriteria(Personas persona, Alumnos alumno, Materias materia, Paises pais, Estados estado, Municipios municipio, Colonias colonia){
